...
define(['jquery', 'cordova', 'app', 'localizer', 'DALMain', 'commonScriptManager'],
    ...
    DALProjects.addProject = function(ProjectID, projectNo, referenceNo, projectName, addressLine1, addressLine2, city, postalCode, state, country, status, percentComplete, notes, rowGUID, surveyType, successAddProjectCallBack) { 
        var db = DALMain.db;
        ...
        try{
             db.transaction(function(tx) { 
                ...
                tx.executeSql("INSERT INTO Projects(ProjectID, projectNo, referenceNo, projectName, addressLine1, addressLine2, city, postalCode, state, country, status, percentComplete, notes, addedOn, RowGUID, SurveyTypeID) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", 
                              [ProjectID, projectNo, referenceNo, projectName, addressLine1, addressLine2, city, postalCode, state, country, status, percentComplete, notes, addedOn, rowGUID, surveyType], 
