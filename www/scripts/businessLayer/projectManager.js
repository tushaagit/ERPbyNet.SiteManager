define(['jquery', 'cordova', 'kendo', 'app', 'localizer', 'WSHandler', 'buildingManager','DALProjects', 'DALBuildings', 'DALGroups', 'DALSets', 'installationGroupsManager', 'DALInstallationGroups'],
       function ($, cordova, kendo, app, localizer, WSHandler, buildingManager,DALProjects, DALBuildings, DALGroups, DALSets, installationGroupsManager, DALInstallationGroups) {
    ...
    projectManager.addProject = function(projectsInfo, surveyTypeID, successAddProjectCallBack){
        ...
        ,projectsInfo.PercentComplete,projectsInfo.Notes, projectsInfo.RowGuid, surveyTypeID, projectsInfo.ContractNo, projectsInfo.NoOfUnits, successAddProjectCallBack);
          ...
          //check if project exists, if not insert project data
           if(surveyTypeIds[projectsInfo[key].ProjectID]!= undefined)
             ...
             SITE_SURVEY_TYPE = app.config.defaultSurveyTypeID;
                ...
                installationGroupsManager.insertAllInstallationGroupsData(projectsInfo[key]);
			});
